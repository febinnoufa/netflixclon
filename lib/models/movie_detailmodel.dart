...
class MovieDeatailModel {
    ...
    factory MovieDeatailModel.fromRawJson(String str) => MovieDeatailModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory MovieDeatailModel.fromJson(Map<String, dynamic> json) => MovieDeatailModel(
        adult: json["adult"],
